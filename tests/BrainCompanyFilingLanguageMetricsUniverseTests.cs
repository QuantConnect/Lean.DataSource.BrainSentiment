...
{
    [TestFixture]
    public class BrainCompanyFilingLanguageMetricsUniverse10KTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        public void Selection()
        {
            ...
            var expected = from d in datum
                            where d.ReportSentiment.Sentiment < 10m && d.RiskFactorsStatementSentiment.Sentiment < 0m
                            select d.Symbol;
        ...
        private BaseData CreateNewInstance()
        {
            return new BrainCompanyFilingLanguageMetricsUniverse10K
                {
                    ReportSentiment = BrainCompanyFilingLanguageMetrics.Parse(new List<string>{"1", "1", "1", "1", "", "", "", "", "", "", ""}),
                    RiskFactorsStatementSentiment = BrainCompanyFilingLanguageMetrics.Parse(new List<string>{"1", "1", "1", "1", "", "", "", "", "", "", ""}),
                    ManagementDiscussionAnalyasisOfFinancialConditionAndResultsOfOperations = BrainCompanyFilingLanguageMetrics.Parse(new List<string>{"1", "1", "1", "1", "", "", "", "", "", "", ""}),
        ...
        private IEnumerable<BrainCompanyFilingLanguageMetricsUniverse10K> CreateNewSelection()
        {
            return new []
            {
                new BrainCompanyFilingLanguageMetricsUniverse10K
                {
                    ReportSentiment = BrainCompanyFilingLanguageMetrics.Parse(new List<string>{"1", "1", "1", "1", "", "", "", "", "", "", ""}),
                    RiskFactorsStatementSentiment = BrainCompanyFilingLanguageMetrics.Parse(new List<string>{"1", "1", "1", "1", "", "", "", "", "", "", ""}),
                    ManagementDiscussionAnalyasisOfFinancialConditionAndResultsOfOperations = BrainCompanyFilingLanguageMetrics.Parse(new List<string>{"1", "1", "1", "1", "", "", "", "", "", "", ""}),
