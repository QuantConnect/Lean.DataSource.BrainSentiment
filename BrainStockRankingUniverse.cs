...
namespace QuantConnect.DataSource
{
    ...
    public class BrainStockRankingUniverse : BaseData
    {
        ...
        public override BaseData Reader(SubscriptionDataConfig config, string line, DateTime date, bool isLiveMode)
        {
            ...
            {
                Rank2Days = decimal.Parse(csv[2], NumberStyles.Any, CultureInfo.InvariantCulture),
        ...
        {
            return $"{Symbol} - Rank2Days: {Rank2Days} - Rank3Days: {Rank3Days} - Rank5Days: {Rank5Days} - Rank10Days: {Rank10Days} - Rank21Days: {Rank21Days}";
        }
